...
unsigned long lowpagetable[1024] __attribute__ ((aligned (4096)));
 ...
 /* This function fills the page directory and the page table, then
  * enables paging by putting the address of the page directory into
  * the CR3 register and setting the 31st bit into the CR0 one
  */
void init_paging()
{
